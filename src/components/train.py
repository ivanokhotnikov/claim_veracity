...
def train(tokenized_dataset: Input[Dataset], loaded_model: Input[Model],
          batch_size: int, epochs: int, learning_rate: float, timestamp: str,
          project_id: str, location: str, exp_name: str,
